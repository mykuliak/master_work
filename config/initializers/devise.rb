...
Devise.setup do |config|
  ...
  config.omniauth :facebook, Rails.application.credentials.send(Rails.env)[:facebook_app_id],
                  Rails.application.credentials.send(Rails.env)[:facebook_app_secret], scope: [:email]
